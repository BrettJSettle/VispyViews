...
def main():
    ...
    for name in ('future', 'PIL', 'pyqtgraph', 'vispy', 'pyopengl', 'file_manager'):
        test_dependency(name, installers=['pip'])
...
if __name__ == '__main__' or INSTALL_DEPENDENCIES:
    ...
    submodules = {'scipy': ['ndimage', 'special'], }
    gohlke_aliases = {}
    aliases = {'pyopengl': 'OpenGL'}
